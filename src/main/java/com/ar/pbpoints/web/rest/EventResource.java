...
/**
 * REST controller for managing {@link com.ar.pbpoints.domain.Event}.
 */
@RestController
@RequestMapping("/api")
public class EventResource {
    ...
    */
    ...
    public ResponseEntity<String> createEventXML(@PathVariable Long id) throws URISyntaxException, ParserConfigurationException, TransformerConfigurationException, IOException {
