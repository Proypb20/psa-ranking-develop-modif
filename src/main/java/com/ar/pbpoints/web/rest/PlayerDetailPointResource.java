...
import com.ar.pbpoints.service.PlayerDetailPointService;
import com.ar.pbpoints.web.rest.errors.BadRequestAlertException;
import com.ar.pbpoints.service.dto.PlayerDetailPointDTO;
import com.ar.pbpoints.service.dto.PlayerDetailPointCriteria;
import com.ar.pbpoints.service.PlayerDetailPointQueryService;
...
/**
 * REST controller for managing {@link com.ar.pbpoints.domain.PlayerDetailPoint}.
 */
@RestController
@RequestMapping("/api")
public class PlayerDetailPointResource {
    ...
    public PlayerDetailPointResource(PlayerDetailPointService playerDetailPointService, PlayerDetailPointQueryService playerDetailPointQueryService) {
    ...
    public ResponseEntity<PlayerDetailPointDTO> createPlayerDetailPoint(@Valid @RequestBody PlayerDetailPointDTO playerDetailPointDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/player-detail-points/" + result.getId()))
    ...
    public ResponseEntity<PlayerDetailPointDTO> updatePlayerDetailPoint(@Valid @RequestBody PlayerDetailPointDTO playerDetailPointDTO) throws URISyntaxException {
