...
import com.psa.ranking.service.TeamPointService;
import com.psa.ranking.web.rest.errors.BadRequestAlertException;
import com.psa.ranking.service.dto.TeamPointDTO;
import com.psa.ranking.service.dto.TeamPointCriteria;
import com.psa.ranking.service.TeamPointQueryService;
...
/**
 * REST controller for managing {@link com.psa.ranking.domain.TeamPoint}.
 */
@RestController
@RequestMapping("/api")
public class TeamPointResource {
    ...
    public ResponseEntity<TeamPointDTO> createTeamPoint(@Valid @RequestBody TeamPointDTO teamPointDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/team-points/" + result.getId()))
