...
import com.psa.ranking.service.dto.PlayerPointCriteria;
import com.psa.ranking.service.PlayerPointQueryService;
...
/**
 * REST controller for managing {@link com.psa.ranking.domain.PlayerPoint}.
 */
@RestController
@RequestMapping("/api")
public class PlayerPointResource {
    ...
    public ResponseEntity<PlayerPointDTO> createPlayerPoint(@Valid @RequestBody PlayerPointDTO playerPointDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/player-points/" + result.getId()))
