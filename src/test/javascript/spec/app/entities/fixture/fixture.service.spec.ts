...
describe('Service Tests', () => {
  describe('Fixture Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(FixtureService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Fixture(0, Status.PENDING);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Fixture', () => {
        const returnedFromService = Object.assign(
          {
            status: 'BBBBBB'
          },
