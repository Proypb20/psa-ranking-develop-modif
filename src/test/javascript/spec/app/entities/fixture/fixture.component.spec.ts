...
import { FixtureComponent } from 'app/entities/fixture/fixture.component';
import { FixtureService } from 'app/entities/fixture/fixture.service';
import { Fixture } from 'app/shared/model/fixture.model';

describe('Component Tests', () => {
  describe('Fixture Management Component', () => {
    let comp: FixtureComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FixtureComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fixtures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
